<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <header class="container-fluid">
            <div class="container clearfix p-2">
                <a href="${cp}index" class="float-start"><img src="${cp}images/unnamed2.png" alt="로고" class="img-fluid" width="250"></a>
            ...
            <ul class="navbar-nav container justify-content-start">
                ...
                <li class="mx-3 nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="${cp}gallery.html">갤러리</a></li>
                    </ul>
                </li>
            </ul>
        </nav>